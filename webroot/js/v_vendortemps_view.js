    ...
    $.ajax({
        ...
        success: function (response) {
                ...
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        $("#smallScaleFile")
                            .attr(
                                "href",
                                baseurl + val.registration_certificate
                            )
                            .text(
                    ...
                    <div class="card-body">
                        ...
                        `</span>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-6">
                                                <a class="btn btn-app btn-block" target="_blank" href="` +
                        val.installed_capacity_file +
                        `">
            ...
            <tr>
                ...
                $.each(
                    response.message[0].partner_address,
                    function (index, val) {
                        partenerView =
                            `<div class="col-4">
                    <div class="card">
                ...
                $("#bankName").text(response.message[0]["bank_name"]);

                $("#bankBranch").text(response.message[0]["bank_branch"]);

                $("#bankNumber").text(response.message[0]["bank_number"]);

                $("#bankIfsc").text(response.message[0]["bank_ifsc"]);

                $("#bankKey").text(response.message[0]["bank_key"]);

                $("#bankCountry").text(response.message[0]["bank_country"]);

                $("#bankCity").text(response.message[0]["bank_city"]);

                $("#bankCurrency").text(response.message[0]["order_currency"]);

                $("#bankSwift").text(response.message[0]["bank_swift"]);

                $("#bankTan").text(response.message[0]["tan_no"]);

                $("#bankCin").text(response.message[0]["cin_no"]);

                $("#gstNo").text(response.message[0]["gst_no"]);

                $("#panNo").text(response.message[0]["pan_no"]);

                $("#gstNoFile").attr(
                    "href",
                    baseurl + response.message[0]["gst_file"]
                );
                $("#panNoFile").attr(
                    "href",
                    baseurl + response.message[0]["pan_file"]
                );
                $("#cancelledCheque").attr(
                    "href",
                    baseurl + response.message[0]["bank_file"]
                );

                $("#sixSigma").text(
                    response.message[0].other_details[0].six_sigma
                );
                $("#isoRegi").text(response.message[0].other_details[0].iso);
                $("#sixSigmaFile").attr(
                    "href",
                    baseurl +
                        response.message[0].other_details[0].six_sigma_file
                );
                $("#isoRegiFile").attr(
                    "href",
                    baseurl + response.message[0].other_details[0].iso_file
                );
                $("#hakaRegiFile").attr(
                    "href",
                    baseurl + response.message[0].other_details[0].halal_file
                );
                $("#isoDecleration").attr(
                    "href",
                    baseurl +
                        response.message[0].other_details[0].declaration_file
                );
                ...
                $.each(
                    response.message[0].questionnaire,
                    function (index, val) {
                ...
                $.each(
                    response.message[0].reputed_customer,
                    function (index, val) {
                        var reputedCustomer =
                            `<div class="col-4">
                                    <div class="card">
