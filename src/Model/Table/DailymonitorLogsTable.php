 ...
 */
class DailymonitorLogsTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setTable('dailymonitor_logs');
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->decimal('old_confirm_production')
            ->allowEmptyString('old_confirm_production');

            $validator
            ->decimal('new_confirm_production')
            ->allowEmptyString('new_confirm_production');
