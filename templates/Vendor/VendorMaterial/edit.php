...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $vendorMaterial->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $vendorMaterial->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="vendorMaterial form content">
            ...
            <fieldset>
                <legend><?= __('Edit Vendor Material') ?></legend>
                <?php
