...
<script>
    var url_list = "<?php echo \Cake\Routing\Router::url(array('controller' => '/dailymonitor', 'action' => 'update-confirmation')); ?>"
    var getConfirmedProductionUrl = "<?php echo \Cake\Routing\Router::url(array('controller' => '/dailymonitor', 'action' => 'updateconfirmedproduction')); ?>";
</script>
<?= $this->Html->script('a_vekpro/vendor/v_dailymonitor_update_confirmation') ?>