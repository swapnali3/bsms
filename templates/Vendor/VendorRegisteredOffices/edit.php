...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $vendorRegisteredOffice->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $vendorRegisteredOffice->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="vendorRegisteredOffices form content">
            ...
            <fieldset>
                <legend><?= __('Edit Vendor Registered Office') ?></legend>
                <?php
