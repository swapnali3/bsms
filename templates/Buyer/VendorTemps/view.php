            ...
            <div class="card card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Address OF Branch Office / Factory:</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-four-questionnaire" role="tabpanel" aria-labelledby="tab_questionnaire" style="background-color: white;">
                            <table>
                                <tr>
                                    <th>Address of your reputed customers to whom reference can be made (use separate sheet) if necessary:</th>
                                    <td>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Does your company follow any anit - corruption policy (zero corruption ) & has follow ethical code of code / corporate social responsibilities:-</th>
                                    <td>

                                    </td>
                                </tr>
                                <tr>
                                    <th>Does the company have policy &decimate between sexual worker wrt cast, gender, religion and harassment at work place:</th>
                                    <td>

                                    </td>
                                </tr>
                                <tr>
                                    <th>Does the company use any product in the manufacturing of material through recycled material :-:</th>
                                    <td>
...
<script>
    var userView =
        '<?php echo \Cake\Routing\Router::url(array('controller' => '/VendorTemps', 'action' => 'user-credentials')); ?>';
</script>
