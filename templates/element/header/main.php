        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        <li>
                        <?= $this->Html->link(__('MSL Stock'), ['controller' => '/materials'], ['class' => "nav-link", 'escape' => false]) ?>
        ...
        <ul class="order-1 order-lg-3 navbar-nav navbar-no-expand">
            <li class="nav-item dropdown show">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right user-setting" style="left: inherit; right: 10px;">
                    ...
                    <?php endif; ?>
                    <div class="dropdown-divider"></div>
                    <a href="<?= $this->Url->build(['controller' => '/admin-users', 'action' => 'changePassword']) ?>" class="dropdown-item">
