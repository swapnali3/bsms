...
<div class="content admin-console">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="col-12">
                <div class="row">
                  <div class="col-mg-5 col-lg-5 mr-1">
                        ...
                        <div class="main-data">
                          ...
                          <div class="row">
                            <div class="col-md-12 text-right">
                              <button type="button" class="dropdown-toggle btn-drop" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-v "></i></button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item settings" id="Dev_settings-btn" data-prd="0"><i
                  ...
                  <div class="col-mg-5 col-lg-5 ml-1">
                          ...
                          <div class="row">
                            <div class="col-md-12 text-right">
                              <button type="button" class="dropdown-toggle btn-drop" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-v "></i></button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item settings" id="Prd_settings-btn" data-prd="1"><i
                                    class="fas fa-cog"></i> Settings</a>
                                <div class="dropdown-divider"></div>
  ...
  <section class="common-s">
    <div class="row">
      <div class="col-md-8 col-lg-8 Dev_setting hide">
      ...
      <div class="col-md-8 col-lg-8 Prd_setting hide">
              <div class="peddsf">
                <h1>prd section</h1>
              </div>
      </div>
      <div class="col-md-4 col-lg-4 sidecard hide">
        <div class="card" style="height: 88vh;">
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <div class="card switchcard pointer Active_card">
                  <div class="card-body rounded">
                    <div class="main-data">
                      <div class="row">
                        <div class="col-md-12">
