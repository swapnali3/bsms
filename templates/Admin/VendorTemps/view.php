...
<div class="row buyer_profile">
    <div class="col-sm-12 col-md-12 col-lg-3">
        <div class="card">
            <div class="card-body">
                <div class="prof-img text-center">
                    <img width="100px" src="<?= $this->Url->build('/') ?>img/<?= strtoupper(substr($vendorTemp->name,0,1)) ?>.png"
                        alt="Vendor">
                </div>
                <div class="mt-3">
                    <table>
            ...
            <div class="card card-tabs card_boxshadow">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class=" p-0" id="vendor-custom-tabs-one-tab" style="border-bottom: 1px solid #eee;">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 mt-4">
                                                    Whether the item is completely manufactured in applicant's
                                                    factory?<br>
                                                    <b>
