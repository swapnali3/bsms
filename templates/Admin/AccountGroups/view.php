...
<div class=" po_padding">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Account Group'), ['action' => 'edit', $accountGroup->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Account Group'), ['action' => 'delete', $accountGroup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $accountGroup->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Account Groups'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Account Group'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="accountGroups view content">
